...
namespace opal {
	...
	class TransmitterManager {
		...
		public:
			...
			//Add transmitter to next parallel transmission with multichannel and different frequency
			void addTransmitterToGroup(int txId, float transmitPower, optix::float3 origin, optix::float3 polarization, float frequency); 
