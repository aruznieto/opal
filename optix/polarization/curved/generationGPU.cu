...
RT_PROGRAM void genRaysOnLaunch()
{
	...
	CurvedMeshLPWavePayload rayPayload;
	...
	//trace ray
	traceReflection<CurvedMeshLPWavePayload>(rayPayload, rayTypeIndex, origin, ray_direction, launchIndex.x,launchIndex.y,false);
