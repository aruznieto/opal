...
#endif
		//rtPrintf("RL\t%u\t%u\t\t%f\t%f\t%f\t%f\t%f\t%f\t%f\n", x, y,   ray_direction.x, ray_direction.y, ray_direction.z, rayPayload.hitPointAtt.x, rayPayload.hitPointAtt.y, rayPayload.hitPointAtt.z, rayPayload.ndtd.w);
